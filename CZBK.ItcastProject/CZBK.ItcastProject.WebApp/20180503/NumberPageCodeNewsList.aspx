<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NumberPageCodeNewsList.aspx.cs" Inherits="CZBK.ItcastProject.WebApp._20180503.NumberPageCodeNewsList" %>
        ...
        <div id="main_column">
            ...
            <div id="content_column">
                ...
                <div class="cont">
                    ...
                    <div class="page_nav"><a href="NumberPageCodeNewsList.aspx?pageIndex=1">首页</a><%=PagebarHelper.GetPagebar(PageIndex,PageCount) %>&nbsp<a href="NumberPageCodeNewsList.aspx?pageIndex=<%=PageCount %>">尾页</a>页次：<span style="color:red"><%=PageIndex %></span>/<span style="color:red"><%=PageCount %></span>页 </div>
                </div>
            </div>
            <div class="clear"></div>
        </div>
