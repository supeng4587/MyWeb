<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsList.aspx.cs" Inherits="CZBK.ItcastProject.WebApp._20180503.NewsList" %>
...
<head>
    ...
    <link href="WebDemos/style/style.css" rel="stylesheet" />
        ...
        <div id="main_column">
            ...
            <div id="content_column">
                ...
                <div class="cont">
                    ...
                    <div class="pages">  |  <a href="NewsList.aspx?pageIndex=1">首页</a>  |  <a href="NewsList.aspx?pageIndex=<%=PageIndex-1<1?1:PageIndex-1 %>">前页</a>  |  <a href="NewsList.aspx?pageIndex=<%=PageIndex+1>PageCount?PageCount:PageIndex+1 %>">后页</a> | <a href="NewsList.aspx?pageIndex=<%=PageCount %>">尾页</a>         页次：<span style="color:red"><%=PageIndex %></span>/<span style="color:red"><%=PageCount %></span>页 </div>
                </div>
            </div>
            <div class="clear"></div>
        </div>
