        ...
        <div>
            <table>
                ...
                <tr>
                    <td>UserName：</td>
                    <td>
                        <input type="text" name="txtUserName" value="<%=userInfoHtml.UserName %>" /></td>
                </tr>
                <tr>
                    <td>UserPass:</td>
                    <td>
                        <input type="password" name="passUserPass" value="<%=userInfoHtml.UserPass %>" /></td>
                </tr>
                <tr>
                    <td>Email:</td>
                    <td>
                        <input type="text" name="txtEmail" value="<%=userInfoHtml.Email %>" /></td>
                </tr>
                <tr>
                    <td>RegTime:</td>
